...
check_age_dummies = age_dummies.sum(axis=1)
#print(check_age_dummies.sum())
#print(check_age_dummies.unique())
...
print(age_dummies.columns)
age1 = age_dummies.loc[:,'28':'29'].max(axis=1)
age2 = age_dummies.loc[:,'30':'39'].max(axis=1)
age3 = age_dummies.loc[:,'40':'49'].max(axis=1)
age4 = age_dummies.loc[:,'50':'58'].max(axis=1)

data = data.drop (['ID','Reason for Absence', 'Age'], axis=1)

data = pd.concat([data, reason1, reason2, reason3, reason4], axis=1)
data_concat_with_dummies = pd.concat([data, age1, age2, age3, age4], axis=1)
...
columns_reordered = ['reason_1', 'reason_2', 'reason_3', 'reason_4',
					...
					'age_1', 'age_2', 'age_3', 'age_4', 'Absenteeism Time in Hours']
...
columns_reordered = ['reason_1', 'reason_2', 'reason_3', 'reason_4',
       ...
       'Body Mass Index', 'Education', 'Children', 'Pets', 'age_1', 'age_2',
       'age_3', 'age_4', 'Month', 'Weekday', 'Absenteeism Time in Hours']
